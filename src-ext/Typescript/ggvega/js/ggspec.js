...
(function (Orient) {
    ...
    Orient["BottomLeft"] = "bottom-left";
    Orient["BottomRight"] = "bottom-right";
    Orient["Left"] = "left";
    Orient["None"] = "none";
    Orient["Right"] = "right";
    Orient["Top"] = "top";
    Orient["TopLeft"] = "top-left";
    Orient["TopRight"] = "top-right";
})(Orient || (Orient = {}));
...
* __Default value:__ `"stderr"`.
*/
export var ErrorBarExtent;
(function (ErrorBarExtent) {
    ErrorBarExtent["Ci"] = "ci";
    ErrorBarExtent["Iqr"] = "iqr";
    ErrorBarExtent["MinMax"] = "min-max";
    ErrorBarExtent["Stderr"] = "stderr";
    ErrorBarExtent["Stdev"] = "stdev";
})(ErrorBarExtent || (ErrorBarExtent = {}));
