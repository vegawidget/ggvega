...
export type ColorCondition = PurpleConditionalValueDef[] | ConditionalPredicateStringValueDefClass;
...
export interface Predicate {
   ...
   */
  equal?: SelectionInitArrayElement;
  /**
   ...
   */
  oneOf?: SelectionInitArrayElement[];
  /**
...
export type SelectionInitArrayElement = boolean | DateTime | number | string;
...
export interface Legend {
   ...
   */
  values?: SelectionInitArrayElement[];
  /**
 ...
 * domain.
 */
export type DomainUnion = SelectionInitArrayElement[] | DomainClass | Domain;
 ...
 * __Note:__ `null` is not supported for `row` and `column`.
 */
export type Sort = SelectionInitArrayElement[] | EncodingSortField | SortOrder | null;
 ...
 * __Note:__ `null` is not supported for `row` and `column`.
 */
export type SortArray = SelectionInitArrayElement[] | SortEncodingSortField | SortOrder | null;
...
export type FillOpacityCondition = FluffyConditionalValueDef[] | ConditionalPredicateNumberValueDefClass;
...
export type HrefCondition = ConditionalValueDef[] | ConditionalPredicateTextFieldDefClass;
...
export type ConditionUnion = PurpleConditionalValueDef[] | Conditional;
...
export type TooltipUnion = TextFieldDef[] | FieldDefWithConditionTextFieldDefValue | null;
 ...
 * `0` to `1` for opacity).
 */
export type XValue = number | PurpleValue;
 ...
 * `0` to `1` for opacity).
 */
export type YValue = number | FluffyValue;
...
export type Tooltip = TooltipContent | null | string;
...
export type SelectionDefInit =
  | Array<{[key: string]: SelectionInitArrayElement}>
  | {[key: string]: InitSelectionInitMapping};

export type InitSelectionInitMapping = SelectionInitArrayElement[] | boolean | DateTime | number | string;
...
export interface IntervalSelectionConfig {
   ...
   * initial values.
   */
  init?: {[key: string]: SelectionInitArrayElement[]};
  /**
   * An interval selection also adds a rectangle mark to depict the
   * extents of the interval. The `mark` property can be used to customize the
   * appearance of the mark.
...
export type MultiInit = Array<{[key: string]: SelectionInitArrayElement}> | {[key: string]: SelectionInitArrayElement};
