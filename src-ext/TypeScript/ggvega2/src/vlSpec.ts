 ...
 * __Default value:__ `"all"`.
 */
export type AlignUnion = RowColLayoutAlign | LayoutAlign;
 ...
 * __Default value__: `pad`
 */
export type Autosize = AutoSizeParams | AutosizeType;
...
export type TopLevelSpecCenter = boolean | RowColBoolean;
 ...
 * Generate graticule GeoJSON data for geographic reference lines.
 */
export type Graticule = boolean | GraticuleParams;
 ...
 * Generate sphere GeoJSON data for the full globe.
 */
export type SphereUnion = boolean | SphereClass;
...
export interface Encoding {
     ...
     */
    color?: DefWithConditionMarkPropFieldDefStringNull;
    /**
     ...
     */
    fill?: DefWithConditionMarkPropFieldDefStringNull;
    /**
     ...
     */
    fillOpacity?: DefWithConditionMarkPropFieldDefNumber;
    /**
     ...
     */
    opacity?: DefWithConditionMarkPropFieldDefNumber;
    /**
     * Order of the marks.
     ...
     */
    shape?: DefWithConditionMarkPropFieldDefTypeForShapeStringNull;
    /**
     * Size of the mark.
     ...
     */
    size?: DefWithConditionMarkPropFieldDefNumber;
    /**
     ...
     */
    stroke?: DefWithConditionMarkPropFieldDefStringNull;
    /**
     ...
     * property.
     */
    strokeOpacity?: DefWithConditionMarkPropFieldDefNumber;
    /**
     ...
     */
    strokeWidth?: DefWithConditionMarkPropFieldDefNumber;
    /**
 ...
 * }
 */
export interface DefWithConditionMarkPropFieldDefStringNull {
    /**
 ...
 * documentation.
 */
export type Aggregate = ArgmDef | AggregateOp;
...
export type ColorCondition = ConditionalStringValueDef[] | ConditionalPredicateStringValueDefClass;

export interface ConditionalStringValueDef {
    /**
...
export interface Predicate {
     ...
     */
    equal?: SelectionInitIntervalElement;
    /**
     ...
     */
    oneOf?: SelectionInitIntervalElement[];
    /**
...
export type SelectionInitIntervalElement = boolean | DateTime | number | string;
...
export type Lt = DateTime | number | string;
...
export interface Legend {
     ...
     */
    values?: SelectionInitIntervalElement[];
    /**
 ...
 * ..., `900` where `"normal"` = `400` and `"bold"` = `700`).
 */
export type FontWeight = number | FontWeightEnum;
 ...
 * __Default value:__ `true`.
 */
export type LabelOverlap = boolean | LabelOverlapEnum;
 ...
 * domain.
 */
export type DomainUnion = SelectionInitIntervalElement[] | DomainClass | Domain;
 ...
 * * __Default value:__ `hcl`
 */
export type InterpolateUnion = ScaleInterpolateParams | ScaleInterpolate;
 ...
 * __Default value:__ `true` for unbinned _quantitative_ fields; `false` otherwise.
 */
export type NiceUnion = boolean | NiceClass | number | NiceTime;
 ...
 * scales.
 */
export type ScaleRange = RangeConfigValueElement[] | string;

export type RangeConfigValueElement = number | string;
 ...
 * Scheme](https://vega.github.io/vega/docs/schemes/#reference) reference.
 */
export type Scheme = SchemeParams | string;
 ...
 * __See also:__ [`sort`](https://vega.github.io/vega-lite/docs/sort.html) documentation.
 */
export type Sort = SelectionInitIntervalElement[] | EncodingSortField | SortOrder | null;
 ...
 * __Note:__ `null` is not supported for `row` and `column`.
 */
export type SortArray = SelectionInitIntervalElement[] | SortEncodingSortField | SortOrder | null;
...
export type Detail = TypedFieldDef[] | TypedFieldDef;
 ...
 * }
 */
export interface DefWithConditionMarkPropFieldDefNumber {
    /**
     * Aggregation function for the field
     * (e.g., `mean`, `sum`, `median`, `min`, `max`, `count`).
     *
     ...
     * A field definition or one or more value definition(s) with a selection predicate.
     */
    condition?: FillOpacityCondition;
    /**
     * __Required.__ A string defining the name of the field from which to pull a data value
     * or an object defining iterated values from the
     * [`repeat`](https://vega.github.io/vega-lite/docs/repeat.html) operator.
...
export type FillOpacityCondition = ConditionalNumberValueDef[] | ConditionalPredicateNumberValueDefClass;

export interface ConditionalNumberValueDef {
    /**
     * Predicate for triggering the condition
     */
    test?: LogicalOperandPredicate;
...
export type HrefCondition = ConditionalValueDef[] | ConditionalPredicateValueDefClass;
...
export interface ConditionalPredicateValueDefClass {
    /**
     * Predicate for triggering the condition
     */
    test?: LogicalOperandPredicate;
...
export type Order = OrderFieldDef[] | OrderFieldDefClass;
 ...
 * }
 */
export interface DefWithConditionMarkPropFieldDefTypeForShapeStringNull {
    /**
     * Aggregation function for the field
     * (e.g., `mean`, `sum`, `median`, `min`, `max`, `count`).
     *
...
export type ConditionUnion = ConditionalStringValueDef[] | Conditional;
...
export type Tooltip = TextFieldDef[] | DefWithConditionTextFieldDefValue | null;
 ...
 * }
 */
export interface DefWithConditionTextFieldDefValue {
    /**
     * Aggregation function for the field
     * (e.g., `mean`, `sum`, `median`, `min`, `max`, `count`).
     *
 ...
 * __Default value:__ `true` for axis of a continuous x-scale. Otherwise, `false`.
 */
export type Label = boolean | number;
...
export type Keyvals = any[] | ImputeSequence;
 ...
 * __See also:__ [`stack`](https://vega.github.io/vega-lite/docs/stack.html) documentation.
 */
export type Stack = boolean | StackOffset | null;
...
export type XUnion = number | XEnum;
...
export type YUnion = number | YEnum;
 ...
 * object](https://vega.github.io/vega-lite/docs/mark.html#mark-def).
 */
export type AnyMark = MarkDefClass | Mark;
...
export type Box = boolean | MarkConfig;
...
export type TooltipUnion = boolean | TooltipContent | number | null | string;
...
export type BoxPlotDefExtent = number | ExtentExtent;
...
export type Line = boolean | OverlayMarkDef;
...
export type PointUnion = boolean | OverlayMarkDef | PointEnum;
...
export type BindUnion = BindEnum | BindBind;
...
export type Autocomplete = Binding | string;
...
export type Debounce = Binding | number;

export type Options = any[] | Binding;
...
export type SelectionDefInit = { [key: string]: SelectionInitIntervalElement }[] | { [key: string]: InitSelectionInitMapping };

export type InitSelectionInitMapping = SelectionInitIntervalElement[] | boolean | DateTime | number | string;
 ...
 * __See also:__ [`toggle`](https://vega.github.io/vega-lite/docs/toggle.html) documentation.
 */
export type Translate = boolean | string;
 ...
 * An object indicating bin properties, or simply `true` for using default bin parameters.
 */
export type TransformBin = boolean | BinParams;
 ...
 * "column"}` can be used to refer to the repeated field respectively.
 */
export type RepeatUnion = string[] | RepeatMapping;
...
export type Spacing = RowColNumber | number;
 ...
 * __Default value:__ `1.5`.
 */
export type BoxplotExtent = number | ExtentEnum;
 ...
 * The bounds calculation to use for legend orient group layout.
 */
export type LayoutBounds = SignalRef | BoundsEnum;

export interface SignalRef {
    signal: string;
}

export type BottomCenter = boolean | SignalRef;

/**
 * The layout direction for legend orient group layout.
 */
export type Direction = SignalRef | Orientation;

export type Margin = SignalRef | number;
 ...
 * __Default value__: `5`
 */
export type Padding = PaddingClass | number;
 ...
 * Default range for _quantitative_ and _temporal_ fields.
 */
export type Category = string[] | CategorySchemeConfig;
...
export type RangeConfigValue = RangeConfigValueElement[] | RangeConfigValueSchemeConfig;
...
export interface IntervalSelectionConfig {
     ...
     * __See also:__ [`init`](https://vega.github.io/vega-lite/docs/init.html) documentation.
     */
    init?: { [key: string]: SelectionInitIntervalElement[] };
    /**
     * An interval selection also adds a rectangle mark to depict the
     * extents of the interval. The `mark` property can be used to customize the
     * appearance of the mark.
...
export type MultiInit = { [key: string]: SelectionInitIntervalElement }[] | { [key: string]: SelectionInitIntervalElement };
