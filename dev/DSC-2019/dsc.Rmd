...
This leaves us with JavaScript. The {V8} package makes it very easy for to call JavaScript code from R; the installation-process is much-less frustrating than Python.
