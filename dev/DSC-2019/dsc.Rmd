...
We hope that the ggspec can be a useful abstraction to help us understand  "what is going on in ggplot2" and "how does this intersecct with Vega-Lite?". As well, should ggplot2 or Vega-Lite change, we hope that we could keep ggspec "fixed" such that we would have to adapt only that part of the translation process (ggplot2-to-ggspec or ggspec-to-Vega-Lite) that would be impacted by such a change.
