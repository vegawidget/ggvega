...
- took inspiration from Vega-Lite itself which translates a Vega-Lite specification into a Vega specification. 

- this compiler is developed in TypeScript, then compiled into ECMAScript 5 (JavaScript), as described in the [Vega-Lite contribution guide](https://github.com/vega/vega-lite/blob/master/CONTRIBUTING.md#suggested-programming-environment).
