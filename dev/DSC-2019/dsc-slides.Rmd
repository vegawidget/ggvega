...
**Our approach:** A 2 step process

1. ggplot2 -> ggspec

  - Convert a ggplot2 object into a "ggspec", a JSON-serializable list  

2. ggspec -> vlspec

  - Convert a "ggspec" into a Vega-Lite specification or "vegaspec".
